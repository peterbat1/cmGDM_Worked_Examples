...
myExperiment <- cmGDM::cm_load_covar_data(myExperiment,
                                          src_folder = "/home/peterw/Nyctimene/EcoCommons/R-scripts/protoype_dev/Examples/gdm_pkg_example_data/",
...
# using information present in the experiment object. For your convenience, this
# function will generate the performance plots if they are not found in the
